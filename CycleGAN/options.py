...
class BaseOption(object):
    def __init__(self):
        ...
        self.args.add_argument('--debug', action='store_true', default=False)
        ...
        self.args.add_argument('--in_channels', type=int, default=3,
                               help='Number of input channels to the generator.')
        self.args.add_argument('--out_channels', type=int, default=3,
                               help='Number of output channels from the generator.')
    ...
    def parse(self):
        ...
        args.dir_model = os.path.join(args.dir_checkpoints, args.dataset_name, 'Model')
...
class TestOption(BaseOption):
    def __init__(self):
        ...
        self.args.add_argument('--is_train', type=bool, default=False)
