...
if __name__ == '__main__':  # if this script is directly implemented(i.e., not imported), do the below codes
    ...
    # define transforms.Compose object for input data pipeline. Here, the transform includes converting a input to a
    # torch.tensor object whose values are within [0, 1] and normalizing the object to have [-1, 1] values.
